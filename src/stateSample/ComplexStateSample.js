...
function ComplexStateSample() {
    ...
    const get = () => {
        if (top != '') {
            let filteredProducts = productsData.slice(0, top);
    ...
    const search = (value) => {
        ...
        let filteredProducts = productsData.filter(q => q.name.toLowerCase().includes(value.toLowerCase()));
...
export default ComplexStateSample